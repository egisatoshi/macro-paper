...
\begin{center}
  ...
  \begin{tabular}{ll}
    ...
    2 &  \thead[l]{\texttt{(MState \{[m Integer 2] [(cons ,m _) (Multiset Integer) \{8 2\}]\} \{\})} \\
                   \textcolor{gray}{\texttt{(MState \{[m Integer 8] [(cons ,m _) (Multiset Integer) \{2 2\}]\} \{\})}} \\
                   \textcolor{gray}{\texttt{(MState \{[m Integer 2] [(cons ,m _) (Multiset Integer) \{2 8\}]\} \{\})}}} \\ \hline
    3 &  \texttt{(MState \{[m Something 2] [(cons ,m _) (Multiset Integer) \{8 2\}]\} \{\})} \\ \hline
    4 &  \texttt{(MState \{[(cons ,m _) (Multiset Integer) \{8 2\}]\} \{[m 2]\})} \\ \hline
    5 &  \thead[l]{\textcolor{gray}{\texttt{(MState \{[,m Integer 8] [_ (Multiset Integer) \{2\}]\} \{[m 2]\})}} \\
