...
The target list does not contain a sequential triple.
As a result, this expression returns an empty list.
Therefore, the time complexity for returning the result is $O(n^2)$.\todo{Why $O(n^2)$ is good?}
...
\todo{explain the usage of various kinds of parenthesis in this paper. (move from the later part of the paper.)}
