...
Racket~\cite{racketWeb} provides more expressive pattern matching than other Scheme implementations.
...
Each element of a tuple pattern is pattern-matched with a corresponding target using a corresponding matcher. \todo{fix}
...
When the pattern is a list, the first element is always handed as a pattern constructor.
