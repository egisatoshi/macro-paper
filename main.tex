...
However, Egi and Nishiwaki did not propose a compiling method of the pattern-matching algorithm of Egison because it is not as simple as the earlier pattern-matching extensions that can be compiled into simple conditional branches.
...
Thanks to (i), we can add a new syntactic sugar to Scheme without modifying a Scheme compiler.
