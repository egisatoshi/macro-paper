...
The \texttt{match-all} expression used in the program below returns a list of the results evaluating the body expression for all the pattern-matching results.
The \texttt{cons} pattern divides a list into the head element and the rest.
...
It allows us to write an arbitrary expression inside a value pattern.
...
I will skip the explanation of the following program for now because the definition of \texttt{multiset} in Scheme will be explained in Sect.~\ref{method-matcher}.
...
\section{Design of Proposed Macros}\label{usage}

This section introduces the syntax of the pattern-matching expressions provided by the proposed Scheme macros.
