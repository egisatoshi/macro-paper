...
The difference between logic programming and functional pattern-matching facility is that logic programming defines a pattern by how to compose data whereas funtional approach defines a pattern how to decompose data.
In many cases, definitions by the later approach are more direct.
